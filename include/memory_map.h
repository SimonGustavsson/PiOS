...
#define LARGE_STACK_SIZE (PAGE_SIZE * 8)

#define MAX_USER_TASKS 20
#define USER_PT_SIZE_IN_BYTES (2048 * sizeof(int))
...
#define DYN_MEM_PA_START 0x01209000
...
#define DYN_MEM_VA_START (KERNEL_VA_START + DYN_MEM_PA_START)
#define USR_VA_START 0x00001000
#define KERNEL_PT_VA_START (KERNEL_VA_START + KERNEL_PA_PT)
#define USER_TTB0S_START (KERNEL_VA_START + USR_PA_START)
#define USER_TASKS_START (USER_TTB0S_START + (MAX_USER_TASKS * USER_PT_SIZE_IN_BYTES))

// Stacks
#define FIQ_STACK_VA_START   (KERNEL_VA_START + FIQ_STACK_PA_START) 
#define IRQ_STACK_VA_START   (KERNEL_VA_START + IRQ_STACK_PA_START) 
#define SVC_STACK_VA_START   0x80C08000
